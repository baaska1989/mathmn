<template>
    <div
        @keydown.window.escape="sidebar = false"
        class="h-screen overflow-hidden flex bg-gray-100"
    >
        <arc-banner />
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <div
                        class="flex-shrink-0 px-4 pb-4 border-b border-gray-100 border-opacity-10 flex items-center"
                    >
                        <a :href="route('welcome')">
                            <img
                                :src="
                                    $page.props.assetUrl +
                                        $page.props.general.white_logo_path
                                "
        ...
        <div class="hidden bg-primary md:flex md:flex-shrink-0">
            <div class="w-72 flex flex-col">
                ...
                >
                    <div
                        class="flex-shrink-0 h-16 px-6 border-b border-gray-100 border-opacity-10 flex items-center"
                    >
                        <a :href="route('welcome')">
                            <img
                                :src="
        ...
        <div class="flex-1 w-full mx-auto w-0 flex flex-col md:px-0">
            <div
                class="relative z-20 flex-shrink-0 flex h-16 bg-white sm:border-b border-gray-200 lg:border-none"
            >
                <button
                    type="button"
                ...
                <div
                    class="flex-1 max-w-5xl mx-auto border-b border-gray-200 flex justify-between px-4 md:px-0"
                >
                    ...
                    <div
                        class="ltr:ml-4 rtl:mr-4 flex items-center md:ltr:ml-6 md:rtl:mr-6"
                    >
                        <!--Rewards Badge-->
                        <rewards-badge
                        ...
                        <div class="ltr:ml-3 rtl:mr-3 relative">
                            <arc-dropdown align="right" width="48">
                                ...
                                <template #content>
                                    ...
                                    <arc-dropdown-link
                                        :href="route('user_subscriptions')"
                                    >
                                        {{ __("My Subscriptions") }}
                                    </arc-dropdown-link>

                                    <arc-dropdown-link
                                        :href="route('user_payments')"
                                    >
                                        {{ __("My Payments") }}
                                    </arc-dropdown-link>
            ...
            <perfect-scrollbar
                class="flex-1 relative h-full z-0 overflow-hidden focus:outline-none"
                ref="scroll"
            ...
            >
                <main class="max-w-5xl mx-auto">
                    <div class="px-4 sm:px-6 md:px-0">
                        <Message
                            v-show="$page.props.successMessage"
                            severity="success"
                            :closable="false"
                        >
